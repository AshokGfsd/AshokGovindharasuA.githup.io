...
const Navbar = () => {
  ...
  useEffect(() => {
    document.body.style.backgroundColor = darkMode ? "white" : "#18181b";
  }, [darkMode]);
  return (
    <>
      <nav
        className={
          darkMode
            ? "bg-gray-700 bg-white border-gray-200 z-50 shadow-lg md:px-8 px-1 fixed w-full top-0"
            : "border-gray-200 z-50 shadow-lg md:px-8 px-1 fixed w-full top-0"
        }
      >
